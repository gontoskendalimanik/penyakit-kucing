    ...
    <div class="py-12">
        <div class="max-w-7xl mx-3 sm:px-6 lg:px-8 xl:text-2xl md:text-xl sm:text-sm">
            <p class="indent-8">Babesiosis kucing adalah penyakit yang ditularkan melalui kutu yang disebabkan oleh
                ...
                penyakit klinis. Babesia felis adalah spesies yang paling umum menyebabkan babesiosis pada kucing,
                dianggap
                endemik di Afrika Selatan. Kucing yang terinfeksi B. felis biasanya mentoleransi parasitemia tinggi
                sebelum
            ...
            <p class="indent-8">Infeksi Babesia pada kucing bersifat sporadis di negara-negara non-Afrika. Di Eropa,
                ...
                demikian, pengetahuan terkini tentang babesiosis kucing di negara-negara Eropa hanya bersifat parsial
                karena
                jumlah kasus yang dideskripsikan termasuk presentasi klinis dan identifikasi molekuler
                spesies Babesia yang
                terlibat terbatas. Dengan demikian, sebagian besar hewan positif ini terdeteksi dalam studi epidemiologi
                dan
                tidak ada data terperinci tentang tanda-tanda klinis yang tersedia. Analisis komprehensif dari
                investigasi
                ini mengungkapkan bahwa sebagian besar hewan positif tidak menunjukkan gejala atau menunjukkan
                perjalanan
            ...
            <p class="indent-8">Dalam laporan kasus ini tanda-tanda klinis, data epidemiologi dan hasil molekuler
                ...
                canis .</p><br>
            <strong>Presentasi kasus</strong>
            <p class="indent-8">Pedoman CARE telah diikuti dalam pelaporan kasus ini. Pada tanggal 10 Maret 2021, seekor
                kucing betina
                European shorthair berusia enam bulan datang ke klinik hewan yang berlokasi di Meira (Spanyol barat
                laut)

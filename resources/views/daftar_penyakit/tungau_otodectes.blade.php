<x-guest-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-3 xl:text-2xl md:text-xl sm:text-sm sm:px-6 lg:px-8">
            ...
            <br>5. Hematoma aural (lepuh darah besar pada telinga, disebabkan oleh pecahnya pembuluh darah kecil
            antara
            kulit dan
            ...
            <p class="indent-8">Tanda-tanda klinis yang umum dengan riwayat kontak dengan kucing atau anjing lain
                ...
                telinga. Meskipun tungau telinga sering menyebabkan penyakit telinga, kondisi lain dapat
                mengakibatkan
                tanda-tanda
                klinis yang sangat mirip dan harus disingkirkan sebelum pengobatan dimulai.</p><br>
            <p class="indent-8">Diagnosis dilakukan dengan mengamati tungau. Hal ini biasanya mudah dan dapat
                dilakukan
                dengan memeriksa telinga
                hewan peliharaan menggunakan otoskop atau dengan pemeriksaan mikroskopis cairan yang keluar dari
                telinga.
                Jika
                telinga terasa sangat sakit, hewan peliharaan mungkin perlu dibius agar telinga dapat diperiksa dan
                diobati
                dengan
                benar.</p><br>
            <strong>Bagaimana tungau telinga diobati?</strong><br>
            <p class="indent-8">Dokter hewan akan memberi tahu Anda tentang produk insektisida mana yang cocok. Ada
                beberapa
                obat telinga yang
                dilisensikan untuk pengobatan tungau telinga pada hewan peliharaan. Tidak ada obat yang dapat
                menembus telur
                atau

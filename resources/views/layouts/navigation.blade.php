<nav x-data="{ open: false }" class="bg-yellow-300 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('daftar_penyakit')" :active="request()->routeIs('daftar_penyakit')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('diagnosa')" :active="request()->routeIs('diagnosa')">
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('diagnosa')" :active="request()->routeIs('diagnosa')">
                    {{ __('Diagnosa Penyakit') }}
                </x-responsive-nav-link>
            </div>

            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('analisa')" :active="request()->routeIs('analisa')">
